...
public class ConnectWindowServer {
    ...
    static public String FindFolder(String FolderName) throws Exception {
        ...
        String command = "powershell -Command \"Get-ChildItem -Path \'" + FolderName
    ...
    static public String SharedFolder(String folderPath, String username, String access) throws Exception {
        ...
        String shareCommand = "New-SmbShare -Name \"SharedFolder\" -Path \"" + folderPath + "\" -FullAccess \""
                + username + "\"\r\n" +
                "Grant-SmbShareAccess -Name \"SharedFolder\" -AccountName \"" + username + "\" -AccessRight " + access
                + " -Force\r\n" +
    ...
    static public String listSharedFolder(String userName) throws Exception {
        ...
        String shareCommand = "\"C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe\" -Command \"" +
                ...
                "$accessList = Get-SmbShareAccess -Name $share.Name | Where-Object { $_.AccountName -eq \'" + userName
                + "\' -and $_.AccessControlType -eq 'Allow' }; " +
                "if ($accessList) { " +
                "Write-Output \\\"User \'" + userName
                + "\' has access to shared folder: $($share.Name) with path: $($share.Path)\\\"; " +
