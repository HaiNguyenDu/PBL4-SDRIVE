...
public class File_handle {
    ...
    try {
        ...
        try (FileWriter fileWriter = new FileWriter(batchFilePath);
            ...
            // Disable inheritance on the file and remove any existing permissions for the user
            ...
            switch (access) {
                ...
                case "RW": // Custom read and write access without delete
                    printWriter.println("icacls \"" + filePath + "\" /grant \"" + domainUser + "\":R /deny \"" + domainUser + "\":W");
                    break;
                default:
